 ...
 * metadata travel in the clear over http:// → a MITM steals them and can
 * inject responses. We therefore enforce https://, tolerating http:// only
 * toward a local address (self-hosting LAN without TLS), never toward a public host.
 *
