...
interface StepContent {
  ...
  sub: string;
  fields: ReactNode;
  /** The seed screens overflow the 280px of the standard fields. */
  wide?: boolean;
  cta: string;
}
...
export function OnboardingView() {
        ...
        return {
          ...
          fields: (
            <>
              ...
              />
              {/* Closed instance: no switch to registration — offering it
  ...
  /** Step 3: generated seed + quiz for a new account, manual entry for an extra device. */
