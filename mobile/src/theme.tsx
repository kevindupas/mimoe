// Palette Mimoe (teal) + sélection du thème — miroir de
// desktop/src/context/ThemeContext.tsx.
//
// Le thème suivait l'OS sans recours possible : "système" reste le défaut, mais
// le choix manuel est persisté comme sur desktop.
